...
function BarangKeluar() {
  ...
  //   if (!isUnmout) {
  //     axios
  //       .get('http://localhost:3000/userRoles')
  //       .then((res) => {
  //         console.log(res);
  //       })
  //       .catch((err) => {
  ...
  return (
    <FusePageCarded
      header={<BarangKeluarHeader getData={getData} data={data} loading={loading} />}
      content={<BarangKeluarTable getData={getData} data={data} loading={loading} />}
